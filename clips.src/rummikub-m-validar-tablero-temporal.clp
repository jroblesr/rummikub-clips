...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-13
        ...
        (validar-tablero)
        ?h1 <- (ficha-temporal (numero ?n1&~0)            (color ?c)           
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h2 <- (ficha-temporal (numero ?n2&0|=(+ ?n1 1))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h3 <- (ficha-temporal (numero ?n3&0|=(+ ?n1 2))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h4 <- (ficha-temporal (numero ?n4&0|=(+ ?n1 3))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h5 <- (ficha-temporal (numero ?n5&0|=(+ ?n1 4))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h6 <- (ficha-temporal (numero ?n6&0|=(+ ?n1 5))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h7 <- (ficha-temporal (numero ?n7&0|=(+ ?n1 6))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h8 <- (ficha-temporal (numero ?n8&0|=(+ ?n1 7))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h9 <- (ficha-temporal (numero ?n9&0|=(+ ?n1 8))  (color ?c|comodin)   
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h10 <- (ficha-temporal (numero ?n10&0|=(+ ?n1 9)) (color ?c|comodin)  
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h11 <- (ficha-temporal (numero ?n11&0|=(+ ?n1 10)) (color ?c|comodin) 
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h12 <- (ficha-temporal (numero ?n12&0|=(+ ?n1 11)) (color ?c|comodin) 
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ?h13 <- (ficha-temporal (numero ?n13&=(+ ?n1 12))  (color ?c)          
                (bloque ?)(id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                (fila ?)(columna ?))
        ...
        (not (exists (ficha-temporal (numero ?x&:(< ?x ?n1))
                                     (color ?c)
                                     (id-jugada-temp ?i)(ok-jugada-temp ~?i))))
        ...
        (modify ?h3 (ok-jugada-temp ?i))
        (modify ?h4 (ok-jugada-temp ?i))
        (modify ?h5 (ok-jugada-temp ?i))
        (modify ?h6 (ok-jugada-temp ?i))
        (modify ?h7 (ok-jugada-temp ?i))
        (modify ?h8 (ok-jugada-temp ?i))
        (modify ?h9 (ok-jugada-temp ?i))
        (modify ?h10 (ok-jugada-temp ?i))
        (modify ?h11 (ok-jugada-temp ?i))
        (modify ?h12 (ok-jugada-temp ?i))
        (modify ?h13 (ok-jugada-temp ?i))
)
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-12
        ...
        ?h1 <- (ficha-temporal (numero ?n1&~0)            (color ?c)          
                                (bloque ?)
                                (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                                (fila ?)(columna ?))
        ?h2 <- (ficha-temporal (numero ?n2&0|=(+ ?n1 1))  (color ?c|comodin)  
                                (bloque ?)
                                (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
        ...
        ?h11 <- (ficha-temporal (numero ?n11&0|=(+ ?n1 10)) (color ?c|comodin)
                                ...
                                (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                                (fila ?)(columna ?))
        ?h12 <- (ficha-temporal (numero ?n12&=(+ ?n1 11))  (color ?c)         
                                (bloque ?)
                                (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                                (fila ?)(columna ?))
         ; Sólo un comodín por escalera.
                                           ...
                                           (neq ?n7 ?n8 ?n9 ?n10 ?n11 ?n12)
                                               (neq ?n8 ?n9 ?n10 ?n11 ?n12)
                                                   (neq ?n9 ?n10 ?n11 ?n12)
                                                       (neq ?n10 ?n11 ?n12)
                                                            (neq ?n11 ?n12)))
        (not (exists (ficha-temporal (numero ?x&:(< ?x ?n1)) (color ?c)
                                     (id-jugada-temp ?i)(ok-jugada-temp ~?i))))
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-11
        ...
        ?h10 <- (ficha-temporal (numero ?n10&0|=(+ ?n1 9)) (color ?c|comodin) 
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h11 <- (ficha-temporal (numero ?n11&=(+ ?n1 10))  (color ?c)         
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-10
        ...
        ?h9 <- (ficha-temporal (numero ?n9&0|=(+ ?n1 8))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h10 <- (ficha-temporal (numero ?n10&=(+ ?n1 9))   (color ?c)         
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-9
        ...
        ?h8 <- (ficha-temporal (numero ?n8&0|=(+ ?n1 7))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h9 <- (ficha-temporal (numero ?n9&=(+ ?n1 8))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-8
        ...
        ?h7 <- (ficha-temporal (numero ?n7&0|=(+ ?n1 6))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h8 <- (ficha-temporal (numero ?n8&=(+ ?n1 7))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-7
        ...
        ?h6 <- (ficha-temporal (numero ?n6&0|=(+ ?n1 5))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h7 <- (ficha-temporal (numero ?n7&=(+ ?n1 6))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-6
        ...
        ?h5 <- (ficha-temporal (numero ?n5&0|=(+ ?n1 4))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h6 <- (ficha-temporal (numero ?n6&=(+ ?n1 5))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-5
        ...
        ?h4 <- (ficha-temporal (numero ?n4&0|=(+ ?n1 3))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h5 <- (ficha-temporal (numero ?n5&=(+ ?n1 4))    (color ?c)          
                               (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-4
        ...
        ?h3 <- (ficha-temporal (numero ?n3&0|=(+ ?n1 2))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h4 <- (ficha-temporal (numero ?n4&=(+ ?n1 3))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-escalera-3
        ...
        ?h2 <- (ficha-temporal (numero ?n2&0|=(+ ?n1 1))  (color ?c|comodin)  
                               ...
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h3 <- (ficha-temporal (numero ?n3&=(+ ?n1 2))    (color ?c)          
                               (bloque ?)
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por escalera.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-serie-4
        (declare (salience +20))
        (validar-tablero)
        ?h1 <- (ficha-temporal (numero ?n1&~0)     (color ?c1) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h2 <- (ficha-temporal (numero ?n2&0|?n1)  (color ?c2) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h3 <- (ficha-temporal (numero ?n3&0|?n1)  (color ?c3) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h4 <- (ficha-temporal (numero ?n4&?n1)    (color ?c4) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-buscar-serie-3
        ...
        ?h2 <- (ficha-temporal (numero ?n2&0|?n1)  (color ?c2) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ?h3 <- (ficha-temporal (numero ?n3&?n1)    (color ?c3) (bloque ?) 
                               (id-jugada-temp ?i)(ok-jugada-temp ?o&~?i)
                               (fila ?)(columna ?))
        ; Sólo un comodín por serie.
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-no-correcto
        (declare (salience -10))
        (validar-tablero)
        ?h1 <- (ficha-temporal (numero ?) (color ?) (bloque ?) 
                               (id-jugada-temp ?i&~-1) (ok-jugada-temp -1)
                               (fila ?) (columna ?))
        =>
...
(defrule M-VALIDAR-TABLERO-TEMPORAL::tablero-temp-si-correcto
        (declare (salience -20))
        (validar-tablero)
        (not (exists (tablero-temp-correcto (correcto no)
                                            (id-jugada-temp ?i&~-1))))
        (not (exists (ficha-temporal (numero ?) (color ?) (bloque ?) 
                                     (id-jugada-temp ?) (ok-jugada-temp -1)
                                     (fila ?) (columna ?))))
        =>
